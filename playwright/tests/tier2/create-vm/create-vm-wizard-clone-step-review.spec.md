...
create step displays the generated clone name, an editable Name field, a readable Description
field, and the expected review sections before creating the clone.
...
- **In-Scope:** Clone wizard flow (3 steps: Deployment details, Source, Review and create);
  ...
  source VM; Review step display of the auto-generated clone name, name editability, description
  field, Create button label, and visible sections; clone VM creation.
...
| 5    | Click Next to Review; verify the auto-generated name, editability, and sections | Clone name is generated and contains "clone"; Name is editable; Description is readable; Details/Storage/Network/Hardware devices sections are visible; Create button says "Clone VirtualMachine" |
